...
public class Main extends Application {
	...
	private void loadImages() {
		...
		ImageManager.instance().loadImage(Utils.IMG_LOGOUT_ICON, "/assets/logout.png");
		...
		ImageManager.instance().loadImage(Utils.IMG_PASSWORD_ICON, "/assets/pass_icon.png");
		...
		ImageManager.instance().loadImage(Utils.IMG_SEARCH_FILE_ICON, "/assets/find_file.png");
